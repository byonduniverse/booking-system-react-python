...
<div class="bg-light">
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        <h1 class="display-4">Kebab Lovers</h1>
        <p class="lead text-muted mb-0">We eat Kebabs. We love Kebabs. We are Kebabs.</p>
        <p class="lead text-muted mb-0">Lorem ipsum dolor sit amet consectetuer.</p>
      </div>
      <div class="col-lg-6 d-none d-lg-block"><img src="assets/kebab_man.jpg" alt="Kebab Man" class="img-fluid rounded-image" /></div>
    </div>
  </div>
</div>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic lead text-muted mb-0">We are willing to improve the world by spreading our message, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        <br />
        <a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
      <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="assets/kebab-pita.jpg" alt="Kebab Pita" class="img-fluid mb-4 mb-lg-0 rounded-image" /></div>
    </div>
    <div class="row align-items-center">
      <div class="col-lg-5 px-5 mx-auto"><img src="assets/kebab3.jpg" alt="" class="img-fluid mb-4 mb-lg-0 rounded-image" /></div>
      <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
        <h2 class="font-weight-light">Not Just About Kebabs</h2>
        <p class="lead font-italic text-muted mb-4">We are aware of the needs of our dear customers worldwide and want to bring you the best opportunities in our power.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container py-5">
    <div class="row mb-4">
      <div class="col-lg-9">
        ...
        <p class="lead font-italic text-muted">Meet our awesome team of kebab men und quo neque error repudiandae fuga? Ipsa laudantium molestias eos 
